...
public class Test {
	...
	public static void main(String[] args) {
		...
		while(true)
		{
            ...
            case 1: 
            	String yesOrNo="";
            	List<Tiles> listTiles=new ArrayList<>();
            	while(!yesOrNo.equalsIgnoreCase("NO")) {
            		...
            		listTiles.add(tiles);
            		System.out.println("Do you want to add more designs YES OR NO");
            		yesOrNo=sc.next();
            	}
            	System.out.println("sample :"+listTiles);
        		int[] rowCounts=repo.add(listTiles);
