...
public class Test {
	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			System.out.println("5. get all tiles");
...
//            	else {
            		...
            		System.out.println("Enter New Value boxsize");
            	    newTiles.setBoxSize(sc.next());
            	    System.out.println("Enter Design No ");
                	//designNo=sc.next();
            		newTiles.setDesignNo(sc.next());
            		System.out.println("Enter New Value light");
                    newQuantity.setL(sc.nextInt());
                    System.out.println("Enter New Value HL");
                    newQuantity.setHl(sc.nextInt());    
                    System.out.println("Enter New Value dark");
                    newQuantity.setD(sc.nextInt());    
                    System.out.println("Enter New Value Floor");
                    newQuantity.setF(sc.nextInt());    
            		newTiles.setQuantity(newQuantity);
            		System.out.println("Enter New Value prize");
            ...
            case 4:
            	...
            	break;
            case 5:
            	System.out.println("get all tiles as list");
            	List<Tiles> tilesList= repo.getAllTiles();
                System.out.println("Box Size Design No Light HightLighter Dark Flooring prize");
                System.out.println("----------------------------------------------------------------------------------");
                for(Tiles tile: tilesList) {
                	System.out.print(tile.getBoxSize()+"\t    "); 
                	System.out.print(tile.getDesignNo()+"\t     ");
                	Quantity quan=tile.getQuantity(); 
                	System.out.print(quan.getL()+"\t");
                	System.out.print(quan.getHl()+"\t");
                	System.out.print(quan.getD()+"\t");
                	System.out.print(quan.getF()+"\t");
                	System.out.print(tile.getPrize()+"\n");
                }
            break;
            case 6:
            ...
            default:
            	System.out.println("Please provide a value between 1 to 6");
